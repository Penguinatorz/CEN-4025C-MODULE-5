...
public class todoFacade {
	...
	public void todoSwitch() {
		do {
			...
			switch (userInputted) {
			case 1:
				System.out.println("Choice 1 has been Selected " + "- Add a to-do item.");
				todoList.addToDo(input.userInputString());
				break;
			case 2:
				System.out
						.println("Choice 2 has been Selected " + "- Delete a to-do item (item numbering starts at 0)");
				todoList.todoCheck(input.userInputInt());
				break;
			case 3:
				System.out.println("Choice 3 has been Selected " + "- Viewing item list");
				todoList.todoView();
				break;
			case 4:
